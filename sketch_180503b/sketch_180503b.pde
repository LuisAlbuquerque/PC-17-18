...
void barra(){
  fill(200,0,0);
  rect(160-(100-energia/2),20,energia,20,5,5,5,5);
}
void barra2(){
  fill(200,0,0);
  rect(500-(100-energia2/2),20,energia2,20,5,5,5,5);
}
